...
constexpr char kCaratFaceEffectListTag[] = "CARAT_FACE_EFFECT_LIST";

}  // namespace

namespace mediapipe {

class CaratFaceEffectRendererCalculator : public CalculatorBase {
  public:
  CaratFaceEffectRendererCalculator() = default;
  ~CaratFaceEffectRendererCalculator() override = default;
...
// static
absl::Status CaratFaceEffectRendererCalculator::GetContract(CalculatorContract* cc) {
...
// static
absl::StatusOr<face_geometry::Mesh3d> CaratFaceEffectRendererCalculator::ReadMesh3dFromFile(const std::string& mesh_3d_path) {
...
// static
absl::StatusOr<std::string> CaratFaceEffectRendererCalculator::ReadContentBlobFromFile(const std::string& unresolved_path) {
