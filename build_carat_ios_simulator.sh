...
bazel build -c opt --config=ios_x86_64 mediapipe/carat:CaratMediapipeGraph
unzip bazel-out/applebin_ios-ios_x86_64-opt-ST-dabdae81af22/bin/mediapipe/carat/CaratMediapipeGraph.zip -d mediapipe/carat
